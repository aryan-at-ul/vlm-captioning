...
"""Script to train VisionCapt model using LoRA."""
...
output_dir = os.path.join(project_root, "checkpoints/lora_model")
...
run_name = f"lora_training_{timestamp}"
...
# Execute command
print(f"Starting LoRA training with command: {cmd}")
